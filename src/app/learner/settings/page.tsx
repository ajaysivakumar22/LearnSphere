...
import {
    Sun, Moon, Monitor, Bell, User, Camera, HelpCircle,
    Settings, PlayCircle, Info, LogOut, ChevronRight, ExternalLink, ChevronDown, ChevronUp, Shield,
} from 'lucide-react';
...
// Section definitions for navigation (learner-focused)
const SECTIONS = [
...
export default function LearnerSettingsPage() {
    ...
    const [bio, setBio] = useState('Learning enthusiast at LearnSphere');
    ...
    const [newCourseNotifications, setNewCourseNotifications] = useState(false);
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <div
                ref={dropdownRef}
                className="sticky top-16 z-30 border-b bg-card shadow-sm"
            >
            ...
            <main className="container mx-auto p-6 lg:p-8">
                ...
                <div className="mx-auto max-w-3xl space-y-8">
                    {/* ===== User Profile ===== */}
                    <section id="profile" className="rounded-xl border bg-card p-8 scroll-mt-32 shadow-sm">
                    ...
                    {/* ===== Notifications ===== */}
                    <section id="notifications" className="rounded-xl border bg-card p-8 scroll-mt-32 shadow-sm">
                        <div className="mb-6 flex items-center gap-3">
                        ...
                        <div className="space-y-5">
                            {[
                                { label: 'Email Notifications', desc: 'Receive notifications via email', state: emailNotifications, set: setEmailNotifications },
                                { label: 'Course Reminders', desc: 'Get reminded to continue your learning', state: courseReminders, set: setCourseReminders },
                                { label: 'New Course Alerts', desc: 'Get notified when new courses are available', state: newCourseNotifications, set: setNewCourseNotifications },
                                { label: 'Achievements', desc: 'Get notified when you earn achievements', state: achievementNotifications, set: setAchievementNotifications },
                            ].map((item) => (
                    ...
                    {/* ===== Video Preferences ===== */}
                    <section id="video" className="rounded-xl border bg-card p-8 scroll-mt-32 shadow-sm">
                        <div className="mb-6 flex items-center gap-3">
                    ...
                    {/* ===== Appearance ===== */}
                    <section id="appearance" className="rounded-xl border bg-card p-8 scroll-mt-32 shadow-sm">
                        <div className="mb-6 flex items-center gap-3">
                    ...
                    {/* ===== Security ===== */}
                    <section id="security" className="rounded-xl border bg-card p-8 scroll-mt-32 shadow-sm">
                        <div className="mb-6 flex items-center gap-3">
                    ...
                    {/* ===== Help & Support ===== */}
                    <section id="help" className="rounded-xl border bg-card p-8 scroll-mt-32 shadow-sm">
                        <div className="mb-6 flex items-center gap-3">
                        ...
                        <div className="space-y-2">
                            {[
                                ...
                                { label: 'Report an Issue', desc: 'Report a bug or problem' },
                            ].map((item) => (
                                <button
                                    key={item.label}
                    ...
                    {/* ===== About ===== */}
                    <section id="about" className="rounded-xl border bg-card p-8 scroll-mt-32 shadow-sm">
                        <div className="mb-6 flex items-center gap-3">
                        ...
                        <div className="space-y-4 text-base text-muted-foreground">
                            <p>
                                ...
                                designed to make learning seamless.
                            </p>
